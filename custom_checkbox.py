...
class CustomCheckBox(UserControl):
    ...
    selection_fill='#183588',size=25,
    stroke_width=2,animation=None,
    checked=False, font_size=17,
    pressed=None):
        super().__init__()
    ...
    def _unchecked(self):
        self.check_box = Container(
            ...
            bgcolor=None,
            border = border.all(color=self.color,
    ...
    def build(self):
        ...
        if self.checked == True:
            ...
            return Column(
                controls=[
                Container(on_click=lambda e:
                self.checked_check(e),
                    content=Row(
                        controls=[
                    self._unchecked(),
                    Text(self.label,
    ...
    def checked_check(self,e):
        ...
        if self.checked == False:
            ...
            self.check_box.border = border.all(color=self.color,width=self.
            stroke_width)
